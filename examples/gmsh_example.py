    ...
    for l in lines:
        ...
        for p in l.points:
            ...
            for corner in corners:
                if corner[0] == x and corner[1] == y and corner[2] == z:
                    add_point = False
            if add_point:
...
def mesh_3D():
    ...
    print("top surface    : ", surface_top.id,
          "midpoint = ", get_surface_midpoint(surface_top))
    ...
    print("bottom surface : ", surface_bottom.id,
          "midpoint = ", get_surface_midpoint(surface_bottom))
    ...
    top, vol, lat = geom.extrude(
        surface_top, translation_axis=axis, num_layers=layers, recombine=True)
